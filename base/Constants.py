...
SHOW_MENU_POSITIONS_SETTINGS, \
    ...
    SHOW_CURRENT_SETTINGS = range(20, 29)
...
TEXT_MENU_BENEFITS_SETTINGS = "Вы можете выбрать тип льготы.\n"
